...
export default function MasterSheetPage() {
  return (
    <VehicleSheet
      ...
      helper={
        <PageHelper>
          The complete record of every vehicle, with all fields in one wide
          grid. Search, filter, and edit anything across your whole stock.
        </PageHelper>
      }
      cols={COLS}
      ...
      summary={(count, selected) =>
        `All vehicle fields in one wide grid. ${count ?? "—"} row${
          count === 1 ? "" : "s"
