...
export interface EventCalendarProps {
  ...
  /**
   * Hide the built-in "New event" button in the toolbar. Pages that render
   * their own create-event affordance (e.g. in the page header) can pair
   * this with a ref to call `openNewEventDialog()`.
   */
