...
export function CommandDialogBackdrop({
  ...
  return (
    <CommandDialogPrimitive.Backdrop
      className={cn(
        "fixed inset-0 z-[900] bg-black/32 backdrop-blur-sm transition-all duration-200 data-ending-style:opacity-0 data-starting-style:opacity-0",
        className,
      )}
...
export function CommandDialogViewport({
  ...
  return (
    <CommandDialogPrimitive.Viewport
      className={cn(
        "fixed inset-0 z-[900] flex flex-col items-center px-4 py-[max(--spacing(4),4vh)] sm:py-[10vh]",
        className,
      )}
