...
export function Card({
  ...
  const defaultProps = {
    className: cn(
      // Clean Nord surface: tight radius + subtle border + soft card shadow.
      "relative flex flex-col rounded-lg border border-border bg-card text-card-foreground shadow-sm",
